...
If enabled, when the user first connects to the BBS, they have the option kbd:[X]_press Login_ available to skip login modules and get to the main prompt quickly.
