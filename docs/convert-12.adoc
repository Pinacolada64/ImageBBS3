...
This method would allow you to revert back to 1.2 at any time in the condition it was last in.
...
. When prompted, type kbd:[2] to `Convert from Image 1.2`.
. Clock setting
...
. At this point, Image will create several files needed for its own operation.
