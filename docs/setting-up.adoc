...
If you select kbd:[1] you will have to set the date and time after every reboot.

If you select (2) the program will ask which device has the Creative Micro Designs Real-Time Clock option. Enter the device number of your CMD device.
