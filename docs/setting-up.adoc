...
If a date different than the last saved timestamp was entered, Image BBS performs AutoMaintenance (nightly tasks such as rotating system logs--more tasks can be added later as desired).
...
12. Select kbd:[D] `Logon Editor`.
13.	Select kbd:[A] `Logon Mods` (Logon Modules).
